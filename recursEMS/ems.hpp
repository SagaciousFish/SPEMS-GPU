...
public:
 ...
 //  omp_set_num_threads(4);
   ...
   //  getrusage( RUSAGE_SELF, &usage );
    ...
    // std::cout << "\r" << name << ": (" << l << "," << d << ") Edited Motifs found is " << motifs.size()<< std::endl;
    // std::cout << "Current Time Usage is " << elapsed << " secs." << std::endl;
    // std::cout << "Current Memory Usage is " << (size_t)usage.ru_maxrss/(1000000.0) << " GB " << std::endl;
