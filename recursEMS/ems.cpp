...
//   } 
// else 
  //printf("The usage method is: ./ems -s recusEMS -l 14 -d 2 -t 2 ../../data/realDNA/hm01r.fasta \n");
  
  if (version == "recusEMS") 
  {
    //printf("The usage method is ./ems -s recursEMS -l %d -d %d -t %d %s\n", params.l, params.d, params.num_threads, input.c_str());
    recursEms ems(input, params.l, params.d, params);
    ems.run();
  }
  else 
  {
